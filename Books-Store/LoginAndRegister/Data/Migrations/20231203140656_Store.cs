    ...
    public partial class Store : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartDatails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CartDatails_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartDatails_ShoppingCarts_ShoppingcartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartDatails_BookId",
                table: "CartDatails",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_CartDatails_ShoppingcartId",
                table: "CartDatails",
